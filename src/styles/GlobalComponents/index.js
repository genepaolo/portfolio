...
export const Section = styled.section.attrs(props => ({
  "data-aos": props.dataaos
    ...
    margin: ${(props) => props.padnav ? "5rem auto 0 auto": "0 auto" };
    max-width: 1040px;
...
export const ButtonBack = styled.div`
  ...
  color: #fff;
  background: ${({ alt }) => alt ? 'linear-gradient(270deg, #ff622e 0%, #B133FF 100%)' : 'linear-gradient(270deg, #614385 0%, #516395 100%)'};
  cursor: pointer;
